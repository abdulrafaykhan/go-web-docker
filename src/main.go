...
func (c *mainController) Get() {
	...
	// Obtain the values of the route parameters defined in the route
	...
	c.Data["operations"] = operation
	c.Data["num1"] = num1
	c.Data["num2"] = num2
	c.TplName = "result.html"

	// Perform the calculation depending upon the route
	switch operation {
	case "sum":
	...
	case "quotient":
		c.Data["result"] = divide(num1, num2)
	case "difference":
